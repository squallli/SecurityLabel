namespace Aitag.Models
{
    ...
    [Table("custpurchase")]
    public partial class custpurchase
    {
        [Key]
        [StringLength(20)]
      ...
      /*  [StringLength(20)]
        ...
        [Column(TypeName = "numeric")]
        public decimal? acadjust { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? pspmoney { get; set; }
        ...
        public DateTime? pregetdate { get; set; }
    }
}
